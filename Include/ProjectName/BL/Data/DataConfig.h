...
namespace Messerli::Data::Fuhrpark {namespace Enum {
    enum KfzType {
        Lkw = 0,
        Pkw = 1,
        All = 2
    ...
    struct Fuhrpark {
        static inline Types::Kfz** array = nullptr;
        static inline Types::Pkw** arrayPkw = nullptr;
        static inline Types::Lkw** arrayLkw = nullptr;
        static inline auto FahrzeugCounter = 0;

        static inline auto LkwCounter = 0;
        static inline auto PkwCounter = 0;
    };

    inline auto FuhrparkMaxSize = 100;

    namespace Objects {
    static void CreateCarpark()
    {
        Types::StadtAuto fuhrpark;
        ...
        fuhrpark . Insert("Qashqai", false, 10056, "Nissan");
        fuhrpark . Insert("Juke", false, 10057, "Nissan");
        fuhrpark . Insert("Micra", false, 10058, "Nissan");
        fuhrpark . Insert("Panamera", true, 10059, "Porsche");
        fuhrpark . Insert("911 Carrera", true, 10060, "Porsche");
        fuhrpark . Insert("Taycan", true, 10061, "Porsche");
        fuhrpark . Insert("Continental", true, 10062, "Bentley");
        fuhrpark . Insert("Bentayga", true, 10063, "Bentley");
        fuhrpark . Insert("Phantom", true, 10064, "Rolls Royce");
        fuhrpark . Insert("Ghost", true, 10065, "Rolls Royce");
        fuhrpark . Insert("Defender", true, 10066, "Land Rover");
        fuhrpark . Insert("Discovery", false, 10067, "Land Rover");
        fuhrpark . Insert("Range Rover", true, 10068, "Land Rover");
        fuhrpark . Insert("XC60", true, 10069, "Volvo");
        fuhrpark . Insert("XC90", true, 10070, "Volvo");
        fuhrpark . Insert("S60", false, 10071, "Volvo");
        fuhrpark . Insert("Aventador", false, 10072, "Lamborghini");
        fuhrpark . Insert("Huracan", false, 10073, "Lamborghini");
        fuhrpark . Insert("Urus", true, 10074, "Lamborghini");
        fuhrpark . Insert("488 GTB", false, 10075, "Ferrari");
        fuhrpark . Insert("F8 Tributo", false, 10076, "Ferrari");
        fuhrpark . Insert("Roma", true, 10077, "Ferrari");
        fuhrpark . Insert("Chiron", false, 10078, "Bugatti");
        fuhrpark . Insert("Veyron", false, 10079, "Bugatti");
        fuhrpark . Insert("Model X", true, 10080, "Tesla");
